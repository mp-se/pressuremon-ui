...
export const useGlobalStore = defineStore('global', {
  ...
  getters: {
    ...
    baseURL() {
      if (import.meta.env.VUE_APP_HOST === undefined) return window.location.href

      logInfo('globalStore.baseURL()', 'Using base URL from env', import.meta.env.VUE_APP_HOST)
      return import.meta.env.VUE_APP_HOST
    },
    uiVersion() {
      return import.meta.env.VUE_APP_VERSION
    },
    uiBuild() {
      return import.meta.env.VUE_APP_BUILD
    },
    disabled32() {
