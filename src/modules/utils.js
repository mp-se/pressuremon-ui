...
export const httpPostFormatOptions = ref([{ label: 'PressureMon', value: '' }])

export const httpGetFormatOptions = ref([{ label: 'PressureMon', value: '' }])

export const influxdb2FormatOptions = ref([{ label: 'PressureMon', value: '' }])

export const mqttFormatOptions = ref([{ label: 'PressureMon', value: '' }])
...
export function isSensorCalibrated() {
  if (config.pressure_zero_correction == 0.0) return false
