<template>
    <div class="container">
        ...
        <form @submit.prevent="save" class="needs-validation" novalidate>
            <div class="row">
                <div class="col-md-6">
                    <BsSelect v-model="config.pressure_sensor_type" :options="sensorOptions" label="Pressure sensor" width=""
                        :disabled="global.disabled"></BsSelect>
                </div>

                <div class="col-md-6">
                    <BsInputReadonly v-model="config.pressure_zero_correction" label="Pressure Zero Correction"
                        help="The correction value for the pressure sensor" :disabled="global.disabled"></BsInputReadonly>
                </div>
            ...
            <div class="row gy-2">
                ...
                <div class="col-md-3">
                    <button @click="calibrate" type="button" class="btn btn-secondary" :disabled="global.disabled">
                        <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"
                            :hidden="!global.disabled"></span>
                        &nbsp;Calibrate sensor&nbsp;<span v-if="badge.deviceCalibratedBadge()"
