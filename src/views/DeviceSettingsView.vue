    ...
    <div class="container">
        ...
        <form @submit.prevent="saveSettings" class="needs-validation" novalidate>
            <div class="row">
                ...
                <div class="col-md-6">
                    <BsInputRadio v-model="config.temp_unit" :options="temperatureOptions" label="Temperature Format" width=""
                        :disabled="global.disabled"></BsInputRadio>
                </div>
                <div class="col-md-6">
                    <BsInputRadio v-model="config.pressure_unit" :options="pressureOptions" label="Pressure Format" width=""
                        :disabled="global.disabled"></BsInputRadio>
                </div>
